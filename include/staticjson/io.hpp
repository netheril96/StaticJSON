...
template <class T>
inline bool from_json_string(const char* str, T& value, ParsingResult& result)
{
    Handler<T> h(&value);
...
template <class T>
inline bool from_json_file(std::FILE* fp, T& value, ParsingResult& result)
{
    Handler<T> h(&value);
...
template <class T>
inline bool from_json_file(const char* filename, T& value, ParsingResult& result)
{
